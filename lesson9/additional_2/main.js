...
for (const user of usersList) {
    ...
    for (let item in user.address) {
        ...
        divStreet.innerText = user.address[item];
        let divSuite = document.createElement('div');
        divSuite.innerText = user.address[item];
        let divCity = document.createElement('div');
        divCity.innerText = user.address[item];
        let divZipcode = document.createElement('div');
        divZipcode.innerText = user.address[item];

        let divGeo = document.createElement('div');
            let divLat = document.createElement('div');
            divLat.innerText = user.address[item].lat;
            let divLng = document.createElement('div');
            divLng.innerText = user.address[item].lng;
    ...
    for (const companyElement in user.company) {
        let divCompanyName = document.createElement('div');
        divCompanyName.innerText = user.company[companyElement];
        let divCatchPhrase = document.createElement('div');
        divCatchPhrase.innerText = user.company[companyElement];
        let divBs = document.createElement('div');
        divBs.innerText = user.company[companyElement];
        divCompany.append(divCompanyName, divCatchPhrase, divBs);
    }


    divContainer.append(divId, divName,divUserName, divEmail, divAddress, divPhone, divWebsite, divCompany);
