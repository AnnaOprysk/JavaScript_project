...
for (const template1Element of template1) {
    console.log(template1Element);
    document.write (`<div class="post-card">`)
    document.write(`<h3>ID ${template1Element.id}. Title ${template1Element.title}</h3>`)
    document.write(`<p> ${template1Element.body}</p>`)
    document.write(`</div>`)
